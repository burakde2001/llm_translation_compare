...
from results.results_discolm import kit_results_discolm
from results.results_gemini import kit_results_gemini
from results.results_gpt import kit_results_gpt35turbo
from results.results_leo import kit_results_leo
from results.results_llama import kit_results_llama32
from results.results_mistral import kit_results_mistral
from results.results_sauerkrautlm import kit_results_sauerkrautlm
...
#
# print("=== Llama 3.2")
# eval_correctness_llama32 = EvalLoop(kit_results_llama32, "correctness", [""])
# asyncio.run(eval_correctness_llama32.evaluate())
#
# print("=== Leo")
# eval_correctness_leo = EvalLoop(kit_results_leo, "correctness", [""])
# asyncio.run(eval_correctness_leo.evaluate())
#
# print("=== DiscoLM")
# eval_correctness_discolm = EvalLoop(kit_results_discolm, "correctness", [""])
# asyncio.run(eval_correctness_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_correctness_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "correctness", [""])
# asyncio.run(eval_correctness_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_correctness_mistral = EvalLoop(kit_results_mistral, "correctness", [""])
...
#
# print("=== Llama 3.2")
# eval_hallucination_llama32 = EvalLoop(kit_results_llama32, "hallucination", context_de)
# asyncio.run(eval_hallucination_llama32.evaluate())
#
# print("=== Leo")
# eval_hallucination_leo = EvalLoop(kit_results_leo, "hallucination", context_de)
# asyncio.run(eval_hallucination_leo.evaluate())
#
# print("=== DiscoLM")
# eval_hallucination_discolm = EvalLoop(kit_results_discolm, "hallucination", context_de)
# asyncio.run(eval_hallucination_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_hallucination_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "hallucination", context_de)
# asyncio.run(eval_hallucination_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_hallucination_mistral = EvalLoop(kit_results_mistral, "hallucination", context_de)
...
#
# print("=== Llama 3.2")
# eval_hallucination_llama32 = EvalLoop(kit_results_llama32, "hallucination", context_en)
# asyncio.run(eval_hallucination_llama32.evaluate())
#
# print("=== Leo")
# eval_hallucination_leo = EvalLoop(kit_results_leo, "hallucination", context_en)
# asyncio.run(eval_hallucination_leo.evaluate())
#
# print("=== DiscoLM")
# eval_hallucination_discolm = EvalLoop(kit_results_discolm, "hallucination", context_en)
# asyncio.run(eval_hallucination_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_hallucination_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "hallucination", context_en)
# asyncio.run(eval_hallucination_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_hallucination_mistral = EvalLoop(kit_results_mistral, "hallucination", context_en)
# asyncio.run(eval_hallucination_mistral.evaluate())
#
# print("=== Gemini 1.5 Pro")
...
#
# print("=== Llama 3.2")
# eval_answer_relevancy_llama32 = EvalLoop(kit_results_llama32, "answer relevancy", [""])
# asyncio.run(eval_answer_relevancy_llama32.evaluate())
#
# print("=== Leo")
# eval_answer_relevancy_leo = EvalLoop(kit_results_leo, "answer relevancy", [""])
# asyncio.run(eval_answer_relevancy_leo.evaluate())
#
# print("=== DiscoLM")
# eval_answer_relevancy_discolm = EvalLoop(kit_results_discolm, "answer relevancy", [""])
# asyncio.run(eval_answer_relevancy_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_answer_relevancy_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "answer relevancy", [""])
# asyncio.run(eval_answer_relevancy_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_answer_relevancy_mistral = EvalLoop(kit_results_mistral, "answer relevancy", [""])
...
#
# print("=== Llama 3.2")
# eval_grammatical_and_spelling_correctness_llama32 = EvalLoop(kit_results_llama32, "grammatical and spelling correctness", [""])
# asyncio.run(eval_grammatical_and_spelling_correctness_llama32.evaluate())
#
# print("=== Leo")
# eval_grammatical_and_spelling_correctness_leo = EvalLoop(kit_results_leo, "grammatical and spelling correctness", [""])
# asyncio.run(eval_grammatical_and_spelling_correctness_leo.evaluate())
#
# print("=== DiscoLM")
# eval_grammatical_and_spelling_correctness_discolm = EvalLoop(kit_results_discolm, "grammatical and spelling correctness", [""])
# asyncio.run(eval_grammatical_and_spelling_correctness_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_grammatical_and_spelling_correctness_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "grammatical and spelling correctness", [""])
# asyncio.run(eval_grammatical_and_spelling_correctness_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_grammatical_and_spelling_correctness_mistral = EvalLoop(kit_results_mistral, "grammatical and spelling correctness", [""])
...
#
# print("=== Llama 3.2")
# eval_grice_maxims_llama32 = EvalLoop(kit_results_llama32, "grice maxims", [""])
# asyncio.run(eval_grice_maxims_llama32.evaluate())
#
# print("=== Leo")
# eval_grice_maxims_leo = EvalLoop(kit_results_leo, "grice maxims", [""])
# asyncio.run(eval_grice_maxims_leo.evaluate())
#
# print("=== DiscoLM")
# eval_grice_maxims_discolm = EvalLoop(kit_results_discolm, "grice maxims", [""])
# asyncio.run(eval_grice_maxims_discolm.evaluate())
#
# print("=== Sauerkraut")
# eval_grice_maxims_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "grice maxims", [""])
# asyncio.run(eval_grice_maxims_sauerkrautlm.evaluate())
#
# print("=== Mistral")
# eval_grice_maxims_mistral = EvalLoop(kit_results_mistral, "grice maxims", [""])
...
#
# print("=== Llama 3.2")
# eval_naturalness_llama32 = EvalLoop(kit_results_llama32, "naturalness", [""])
# asyncio.run(eval_naturalness_llama32.evaluate_mauve(reference))
#
# print("=== Leo")
# eval_naturalness_leo = EvalLoop(kit_results_leo, "naturalness", [""])
# asyncio.run(eval_naturalness_leo.evaluate_mauve(reference))
#
# print("=== DiscoLM")
# eval_naturalness_discolm = EvalLoop(kit_results_discolm, "naturalness", [""])
# asyncio.run(eval_naturalness_discolm.evaluate_mauve(reference))
#
# print("=== Sauerkraut")
# eval_naturalness_sauerkrautlm = EvalLoop(kit_results_sauerkrautlm, "naturalness", [""])
# asyncio.run(eval_naturalness_sauerkrautlm.evaluate_mauve(reference))
#
# print("=== Mistral")
# eval_naturalness_mistral = EvalLoop(kit_results_mistral, "naturalness", [""])
